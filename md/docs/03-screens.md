...
- locationBasedList(mapX, mapY, radius=2000, contentTypeId=12·14)
...
- 고른 곳은 반드시 경유. 남은 자리는 가까운 순으로 채움
- 권장 초과를 막지 않는다. 대신 실제 거리가 늘어난다 (곳당 약 0.55km)

### iOS 구현

- locationBasedList의 dist(m)로 정렬. firstimage로 썸네일
...
| 요소 | 설명 |
|---|---|
| 단계 5개 | 위치 확인 → 관광지 → 이야기 → 길 잇기 → 거리 맞추기 |
